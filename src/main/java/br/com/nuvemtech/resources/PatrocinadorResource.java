...
public class PatrocinadorResource {
    ...
    private final PatrocinadorService service =
            new PatrocinadorService();

    @GET
    public List<Patrocinador> selecionar()
    ...
    @GET
    @Path("/{id}")
    public Patrocinador buscarPorId(@PathParam("id") int id)
            throws SQLException, ClassNotFoundException {
        return service.buscarPorId(id);
    }

    @POST
    public Response inserir(Patrocinador obj,
        ...
        builder.path(
                Integer.toString(obj.getIdPatrocinador())
        );
    ...
    public Response cadastrar(
            CadastroPatrocinadorRequest request) {
