...
public class BeneficiarioDAO {
    ...
    public void deletar(int id) throws SQLException, ClassNotFoundException {
        try (Connection conexao = abrirConexao();
             PreparedStatement stmt = conexao.prepareStatement("DELETE FROM beneficiario WHERE id_bene=?")) {
            stmt.setInt(1, id);
            stmt.executeUpdate();
        }
    }
    ...
    public List<Beneficiario> selecionar() throws SQLException, ClassNotFoundException {
        ...
        try (Connection conexao = abrirConexao();
             PreparedStatement stmt = conexao.prepareStatement("SELECT * FROM beneficiario ORDER BY id_bene");
